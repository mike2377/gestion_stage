...
const TachesStagiaires: React.FC = () => {
  ...
  const handleFilterChange = (name: string, value: string) => {
    ...
    if (newFilters.student) {
      filtered = filtered.filter(task => task.studentId === newFilters.student);
    }
                            ...
                            <tr key={task.id}>
                              ...
                              <td>
                                <div className="d-flex align-items-center">
                                  <img 
                                    src={task.studentPhoto || '/default-avatar.png'} 
                                    alt="Photo"
                                    className="rounded-circle me-2"
                                    style={{ width: '30px', height: '30px', objectFit: 'cover' }}
                                  />
                                  <div>
                                    <strong>{task.studentName}</strong><br />
                        ...
                        <div key={task.id} className="card mb-3 task-card">
                          <div className="card-body">
                            ...
                            <div className="d-flex justify-content-between align-items-center">
                              <small className="text-muted">{task.studentName}</small>
                  ...
                  <div className="col-md-8">
                    ...
                    <div className="row mb-3">
                      <div className="col-md-6">
                        <strong>Étudiant:</strong> {selectedTask.studentName}<br />
