        ...
        {profile && (
          <>
            ...
            <div className="mb-3">
              ...
              <input className="form-control" value={profile.department || ''} onChange={e => setProfile({ ...profile, department: e.target.value })} disabled={!isEditing} />
            </div>
            <div className="mb-3">
              <label>Responsabilités</label>
              <input className="form-control" value={profile.responsibilities ? profile.responsibilities.join(', ') : ''} onChange={e => setProfile({ ...profile, responsibilities: e.target.value.split(',').map((s: string) => s.trim()) })} disabled={!isEditing} />
            </div>
